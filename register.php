                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="proses_register.php" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" name="password" id="password" pattern=".{8,}" title="Password harus memiliki minimal 8 karakter" class="form-control form-control-user"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="alamat" name="alamat" class="form-control form-control-user"
