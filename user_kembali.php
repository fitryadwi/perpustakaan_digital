...
<head>
    ...
    <title>Perpustakaan Digital - User Kembali</title>
...
<body id="page-top">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    AND (peminjaman.status_peminjaman = 'Kembalikan')";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            ...
                                            $query_check_review = "SELECT * FROM ulasanbuku WHERE buku_id = $buku_id AND user_id = $user_id ";
                                            $result_check_review = mysqli_query($connect, $query_check_review);
                                            
                                            if (mysqli_num_rows($result_check_review) > 0) {
                                                echo "Sudah diulas";
                                            } else {
                                                echo '<a href="#" class="btn btn-success btn-sm btn-block btn-ulasan" 
                                                        data-bs-toggle="modal" 
                                                        data-bs-target="#ulasanModal' . $buku_id . '">Ulasan</a>';
                                            }
                                            ?>
                                            </td>

                                        <!-- Modal -->
                                    <div class="modal fade" id="ulasanModal<?php echo $row['buku_id']; ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form class="row g-3" action="proses_ulasan.php" method="POST">
                                                <input type="hidden" name="id" value="<?php echo $row['buku_id']; ?>">
                                                <div class="col-md-6">
                                                    <label lass="form-label">Ulasan</label>
                                                    <textarea id="ulasan" name="ulasan" rows="4" cols="40"></textarea>

                                                </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Rating</label>
                                                        <select name="rating" id="" class="form-control form-control-solid">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="user_kembali.php" class="btn btn-secondary">Close</a>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            var detailButtons = document.querySelectorAll('.btn-ulasan');
