...
<head>
    ...
    <title>Perpustakaan Digital - Peminjaman admin</title>
                ...
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" class="btn btn-success"
                                            href="proses_pinjam_admin.php?peminjaman_id=<?php echo $row['peminjaman_id']; ?>&action=terima">Terima</a>
                                        <a type="button" class="btn btn-danger"
                                            href="proses_pinjam_admin.php?peminjaman_id=<?php echo $row['peminjaman_id']; ?>&action=tolak">Tolak</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            <?php
                            $total_pages_query = "SELECT COUNT(*) FROM peminjaman WHERE status_peminjaman = 'Pending'";
