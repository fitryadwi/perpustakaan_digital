...
<head>
    ...
    <title>Perpustakaan Digital -  User Dashboard</title>
            ...
            ?>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-primary shadow h-100 py-2">
                        ...
                        $query = "SELECT COUNT(*) AS total FROM peminjaman WHERE status_peminjaman = 'Terima' AND user_id = $user_id";
                        $result = mysqli_query($connect, $query);
                        $row = mysqli_fetch_assoc($result);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Dipinjam</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $total_dipinjam; ?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <?php 
                        $user_id = $_SESSION['user']['user_id'];
                        $query = "SELECT COUNT(*) AS total FROM peminjaman WHERE status_peminjaman = 'Kembalikan' AND user_id = $user_id";
                        $result = mysqli_query($connect, $query);
                        $row = mysqli_fetch_assoc($result);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $total_kembali; ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <h2 class="text-center" style=" 1px;">Digital Library</h2>
                        <p class="text-center">
